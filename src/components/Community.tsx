...
import { SciFiLandmarkVisual } from './SciFiLandmarkVisual';
        ...
        >
          ...
          {LANDMARKS.map(l => {
            ...
            return (
              ...
              >
                <SciFiLandmarkVisual id={l.id} active={selectedLandmark?.id === l.id} />
                <div className="mt-3 px-4 py-1.5 bg-[#1C1C24]/90 rounded-full border border-white/10 shadow-[0_4px_12px_rgba(0,0,0,0.5)]">
